# 20181205
# Custom function for creating LDAvis using citation network
# We use it in "Citation_Network_08"

# A customized function from the package LDAvis
# Inputs: phi and theta matrix and several parameters
# Outputs a JSON object to be used in the function serVis()
createJSON_cnet <- function(phi = matrix(), theta = matrix(), doc.length = integer(), 
  ...
  default.terms <- vocab[order(term.proportion, decreasing = TRUE)][1:R]
